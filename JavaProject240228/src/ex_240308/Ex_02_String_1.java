...
public class Ex_02_String_1 {
	...
	private static final CharSequence[] fruitArray = null;
	...
	public static void main(String[] args) {
		...
		System.out.println("str3ConcatString.hashCode : " + str3ConcatString.hashCode());
		System.out.println("str4ConcatString.hashCode : " + str4ConcatString.hashCode());
		
		
		//test
		String str5 = new String("hello");
		String str6 = new String("hello");
		System.out.println("System.identityhashCode : " + System.identityHashCode(str5));
		System.out.println("System.identityhashCode : " + System.identityHashCode(str6));
...
//		System.out.println("str7.equals(str9) 비교 " + str7.equals(str9);
		...
		System.out.println("char1 : " + str10.charAt(3));
		System.out.println("str10.charAt(3) : " + str10.charAt(3));
		System.out.println("===============================");
		
		// codePoint(int index) : 해당 인덱스에 있는 유니코드값 리턴
		System.out.println("str10.codePoint(3) : " + str10.codePointAt(3));
		...
		System.out.println("str10.contains(\"HELLOL\") : " + str10.contains("HELLO"));
		...
		System.out.println("str13 :trim() " + str13.trim().length());
		
		// 응용 1) 검색 시, 복붙을 하는데, 공백이 섞여있음.
		// 대소문자 상관없이 등 검색할 때, 
		// 입력된 문자열이 , 
		// 응용 2) 입력된 파일의 확장자를 기준으로 , 이미지 파일의 종류를 분리.
		// abc.jpg, def.png, ghi.jpeg, abcd.MOV, efgh.mp4  (확장명이 있는 경우)
		// 예) 게시글 작성 시 첨부 파일로, 사진도 업로드, 영상도 업로드
		// 내가 올린 게시글을 출력 시 , 이미지 로딩, 영상으로 로딩을 할지 분리 작업을 해야겠지.
		// 
