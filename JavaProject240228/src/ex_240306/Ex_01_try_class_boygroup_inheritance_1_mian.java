...
public class Ex_01_try_class_boygroup_inheritance_1_mian {
	...
	public static void main(String[] args) {
		...
		// 부모클래스 명 참조형 변수 = new 자식 클래스 명();
		// 참조형 변수. 닷 연산자를 통해서 접근이 가능한 메서드는? 1) 부모꺼만 2) 자식꺼만(도)
		//	Idol test = new Ex_01_try_class_boygroup_inheritance_1();
//		test. 정답) 1번 부모꺼만 가능.
		
		// 2번 퀴즈 그렇다면, 해당 인스턴스에 부모 메서드만 보인다면,
		// 자식의 메서드도 보고싶다. 어떻게 해야할까?
		// 1번) 업캐스팅 한다. 2) 다운 캐스팅.
		// 정답은 2번
		// 방법
