...
public class Ex_5_continue_test {
	...
	// 디버깅, 자바, 자바스크립트, 파이썬, 여타 플러트 등.
	// 다른 프로그래밍 언어를 공부할 때, 코드를 분석한다.
	// 방법 1) 줄번호를 더블 클릭 2) 중단점을 시작, 끝을 설정.
	// 실행) Run 디버깅 모드, -> Perspective 모드에서 debug 모드
	// 진행 방식) F5 step into, 함수 안에 들어가거나,
	// 진행 방식2) F6 step over, 실행만 하고 건너뛰기.
